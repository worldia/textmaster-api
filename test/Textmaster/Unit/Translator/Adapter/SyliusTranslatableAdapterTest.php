 ...
 * @group sylius
 */
class SyliusTranslatableAdapterTest extends TestCase
{
    /**
     * @test
     */
    ...
    {
        $managerRegistryMock = $this->createMock('Doctrine\Common\Persistence\ManagerRegistry');
        $translatableMock = $this->createMock('Sylius\Component\Resource\Model\NotTranslatableInterface');
        $adapter = new SyliusTranslatableAdapter($managerRegistryMock);
    ...
    {
        $managerRegistryMock = $this->createMock('Doctrine\Common\Persistence\ManagerRegistry');
        $translatableMock = $this->createMock('Sylius\Component\Resource\Model\TranslatableInterface', ['getId', 'getTranslation', 'hasTranslation', 'setCurrentLocale', 'setFallbackLocale', 'getTranslations', 'addTranslation', 'removeTranslation']);
        $translationMock = new MockTranslation();
        $translationMock->setName('Translated name');
        $documentMock = $this->createMock('Textmaster\Model\Document', ['getProject', 'save'], [], '', false);
        $projectMock = $this->createMock('Textmaster\Model\Project', ['getLanguageFrom'], [], '', false);
