...
use Textmaster\HttpClient\Cache\CacheInterface;
use Textmaster\HttpClient\Cache\FilesystemCache;

/**
 * Performs requests on Textmaster API using If-Modified-Since headers.
